...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    [[AYThemeCenter center] registerTheme:[RedTheme new] forName:@"red"];
    ...
    [[AYThemeCenter center] autoRegisterClass:[UIView class] beforeExecuting:@selector(drawRect:) applyBeforeExecuting:@selector(layoutSubviews)];
